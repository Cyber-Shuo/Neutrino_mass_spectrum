...
# define the Marayona Phase
def majorana_phases(t):
    m_phases = np.exp(t*2j)
    return m_phases

# obtain the effective mass minimum of the nomal order as a function of the minimum neutrino mass, m_1.
...
# obtain the effective mass maximum of the nomal order as a function of the minimum neutrino mass, m_1
...
# obtain the effective mass maximum of the inverse order as a function of the minimum neutrino mass, m_3
...
# obtain the effective mass minimum of the inverse order as a function of the minimum neutrino mass, m_3
